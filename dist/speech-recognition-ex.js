...
var _App_decorators, _init, _a, _b;
import { getRequestHeaders, saveSettingsDebounced, sendMessageAsUser } from "../../../../../script.js";
import { getApiUrl, doExtrasFetch, modules, extension_settings, getContext, ModuleWorkerWrapper } from "../../../../extensions.js";
...
function computed$1(getterOrOptions, debugOptions, isSSR = false) {
  ...
  if (!!(define_process_env_default$3.NODE_ENV !== "production") && debugOptions && !isSSR) {
...
function applyOptions(instance) {
  ...
  if (dataOptions) {
    ...
    if (!!(define_process_env_default$2.NODE_ENV !== "production") && isPromise$1(data)) {
      warn$1(
...
function createAppAPI(render2, hydrate) {
  return function createApp2(rootComponent, rootProps = null) {
    ...
    const app2 = context.app = {
      ...
      mount(rootContainer2, isHydrate, namespace) {
        if (!isMounted) {
          if (!!(define_process_env_default$2.NODE_ENV !== "production") && rootContainer2.__vue_app__) {
            warn$1(
 ...
 If you want to mount another app on the same host container, you need to unmount the previous app by calling \`app.unmount()\` first.`
          ...
          if (isHydrate && hydrate) {
            hydrate(vnode, rootContainer2);
          } else {
            render2(vnode, rootContainer2, namespace);
          }
          isMounted = true;
          app2._container = rootContainer2;
          rootContainer2.__vue_app__ = app2;
          if (!!(define_process_env_default$2.NODE_ENV !== "production") || false) {
    ...
    if (isAsyncSetup) {
      ...
      if (isSSR) {
        ...
        if (!!(define_process_env_default$2.NODE_ENV !== "production") && !instance.suspense) {
          const name = (_a2 = Component2.name) != null ? _a2 : "Anonymous";
          warn$1(
...
function finishComponentSetup(instance, isSSR, skipOptions) {
  ...
  if (!!(define_process_env_default$2.NODE_ENV !== "production") && !Component2.render && instance.render === NOOP && !isSSR) {
...
function compatibleClassDecorator(deco) {
  return function(arg, ctx) {
    ...
    if (ctx) {
      ...
      const proto = (_a2 = Compatible.fakePrototype) !== null && _a2 !== void 0 ? _a2 : Compatible.fakePrototype = {};
...
class Slot {
  ...
  obtainMap(name) {
    let map2 = this.getMap(name);
    if (!map2) {
      map2 = /* @__PURE__ */ new Map();
      this.names.set(name, map2);
    }
    return map2;
  }
  getMap(name) {
    const map2 = this.names.get(name);
    return map2;
  }
}
...
function getSlot(obj) {
  var _a2;
  return (_a2 = Object.getOwnPropertyDescriptor(obj, SlotSymbol)) === null || _a2 === void 0 ? void 0 : _a2.value;
}
    ...
    while (currSlot != null) {
      for (const mapName of currSlot.names.keys()) {
        ...
        if (mapName === "customDecorator") {
          const map3 = currSlot.obtainMap("customDecorator");
          if (map3.has(name)) {
            if (map3.get(name).every((ite) => !ite.preserve)) {
              return false;
            } else {
              continue;
            }
        ...
        const map2 = currSlot.names.get(mapName);
        if (map2.has(name)) {
          return false;
        }
      }
...
function getProviderFunction(provide2) {
...
function build$c(cons, optionBuilder) {
  ...
  const map2 = slot.getMap("setup");
  if (!map2 || map2.size === 0) {
    return;
  }
  const setup2 = function(props, ctx) {
    const setupData = {};
    let promises = null;
    for (const name of map2.keys()) {
      const setupState = map2.get(name).setupFunction(props, ctx);
  ...
  optionBuilder.setup = setup2;
}
function build$b(cons, optionBuilder) {
  var _a2;
  (_a2 = optionBuilder.computed) !== null && _a2 !== void 0 ? _a2 : optionBuilder.computed = {};
  const slot = obtainSlot(cons.prototype);
  const map2 = slot.obtainMap("computed");
...
function build$a(cons, optionBuilder, vueInstance) {
  var _a2;
  (_a2 = optionBuilder.data) !== null && _a2 !== void 0 ? _a2 : optionBuilder.data = {};
  const sample = new cons(optionBuilder, vueInstance);
  let names = getValidNames(sample, (des, name) => {
    var _a3, _b2;
    return !!des.enumerable && !((_a3 = optionBuilder.methods) === null || _a3 === void 0 ? void 0 : _a3[name]) && !((_b2 = optionBuilder.props) === null || _b2 === void 0 ? void 0 : _b2[name]);
  });
  const slot = obtainSlot(cons.prototype);
...
function build$9(cons, optionBuilder) {
  ...
  (_a2 = optionBuilder.hooks) !== null && _a2 !== void 0 ? _a2 : optionBuilder.hooks = {};
  (_b2 = optionBuilder.methods) !== null && _b2 !== void 0 ? _b2 : optionBuilder.methods = {};
  const HookFunctions = {};
  ...
  protoArr.forEach((proto) => {
    ...
    names.forEach((name) => {
      if (HookNames.includes(name) || map2.has(name)) {
...
function applyAccessors(optionBuilder, dataFunc) {
  var _a2;
  (_a2 = optionBuilder.beforeCreateCallbacks) !== null && _a2 !== void 0 ? _a2 : optionBuilder.beforeCreateCallbacks = [];
...
function build$7(cons, optionBuilder) {
  var _a2;
  (_a2 = optionBuilder.watch) !== null && _a2 !== void 0 ? _a2 : optionBuilder.watch = {};
  const slot = obtainSlot(cons.prototype);
...
function build$6(cons, optionBuilder) {
  var _a2;
  (_a2 = optionBuilder.props) !== null && _a2 !== void 0 ? _a2 : optionBuilder.props = {};
  const slot = obtainSlot(cons.prototype);
...
function build$5(cons, optionBuilder) {
  var _a2;
  (_a2 = optionBuilder.inject) !== null && _a2 !== void 0 ? _a2 : optionBuilder.inject = {};
  const slot = obtainSlot(cons.prototype);
...
function build$4(cons, optionBuilder, vueInstance) {
  var _a2;
  (_a2 = optionBuilder.provide) !== null && _a2 !== void 0 ? _a2 : optionBuilder.provide = {};
  const slot = obtainSlot(cons.prototype);
...
function build$3(cons, optionBuilder) {
  var _a2;
  (_a2 = optionBuilder.methods) !== null && _a2 !== void 0 ? _a2 : optionBuilder.methods = {};
...
function build$2(cons, optionBuilder) {
  ...
  names.forEach((value, name) => {
    var _a3;
    const vmodelName = (_a3 = value && value.name) !== null && _a3 !== void 0 ? _a3 : "modelValue";
...
function ComponentOption(cons, extend2) {
  ...
  const raw = Object.assign(Object.assign({ name: cons.name, setup: optionBuilder.setup, data() {
    ...
    return (_a2 = optionBuilder.data) !== null && _a2 !== void 0 ? _a2 : {};
    ...
    return (_a2 = optionBuilder.provide) !== null && _a2 !== void 0 ? _a2 : {};
  } }, optionBuilder.hooks), { extends: extend2 });
  return raw;
}
function buildComponent(cons, arg, extend2) {
  var _a2, _b2;
  const option = ComponentOption(cons, extend2);
  const slot = obtainSlot(cons.prototype);
  ...
  if ("object" === typeof arg.methods && !Array.isArray(arg.methods) && arg.methods !== null) {
    (_a2 = option.methods) !== null && _a2 !== void 0 ? _a2 : option.methods = {};
  ...
  if (!option.setup) {
    ...
    const newSetup = (_b2 = arg.setup) !== null && _b2 !== void 0 ? _b2 : function() {
      return {};
    };
    const setup2 = function(props, ctx) {
  ...
  const map2 = slot.getMap("customDecorator");
  if (map2 && map2.size > 0) {
    map2.forEach((v) => {
  ...
  return /* @__PURE__ */ defineComponent(option);
}
...
const Vue = Base;
const DEBUG_PREFIX$7 = "<Speech Recognition module (Vosk)> ";
class VoskSttProvider {
  ...
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$7 + "Using default vosk STT extension settings");
    }
    ...
    console.debug(DEBUG_PREFIX$7 + "Vosk STT settings loaded");
  }
  async processAudio(audioblob) {
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, "STT Generation Failed  (Vosk)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
...
const DEBUG_PREFIX$6 = "<Speech Recognition module (Whisper Extras)> ";
class WhisperExtrasSttProvider {
  ...
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$6 + "Using default Whisper STT extension settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    $("#speech_recognition_language").val(this.settings.language);
    console.debug(DEBUG_PREFIX$6 + "Whisper (Extras) STT settings loaded");
  }
  async processAudio(audioblob) {
    var requestData = new FormData();
    requestData.append("AudioFile", audioblob, "record.wav");
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, "STT Generation Failed (Whisper Extras)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      throw new Error(`HTTP ${apiResult.status}: ${await apiResult.text()}`);
    }
    const result = await apiResult.json();
    return result.transcript;
...
const DEBUG_PREFIX$5 = "<Speech Recognition module (Whisper OpenAI)> ";
class WhisperOpenAISttProvider {
  ...
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$5 + "Using default Whisper (OpenAI) STT extension settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    $("#speech_recognition_language").val(this.settings.language);
    console.debug(DEBUG_PREFIX$5 + "Whisper (OpenAI) STT settings loaded");
  }
  async processAudio(audioBlob) {
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, "STT Generation Failed (Whisper OpenAI)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      throw new Error(`HTTP ${apiResult.status}: ${await apiResult.text()}`);
    }
    const result = await apiResult.json();
    return result.text;
...
const DEBUG_PREFIX$4 = "<Speech Recognition module (Whisper Local)> ";
class WhisperLocalSttProvider {
  ...
  onSettingsChange() {
    ...
    console.debug(DEBUG_PREFIX$4 + " Updated settings: ", this.settings);
    this.loadSettings(this.settings);
  }
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$4 + "Using default Whisper (Local) STT extension settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    console.debug(DEBUG_PREFIX$4 + "Whisper (Local) STT settings loaded");
  }
  async processAudio(audioBlob) {
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, "STT Generation Failed (Whisper Local)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      throw new Error(`HTTP ${apiResult.status}: ${await apiResult.text()}`);
    }
    const result = await apiResult.json();
    return result.text;
...
const DEBUG_PREFIX$3 = "<Speech Recognition module (Browser)> ";
...
class BrowserSttProvider {
  constructor() {
    ...
    __publicField(this, "processTranscriptFunction", null);
  }
  get settingsHtml() {
    let html = '         <span>Language</span> </br>         <select id="speech_recognition_browser_provider_language">             <option value="ar-SA">ar-SA: Arabic (Saudi Arabia)</option>             <option value="bn-BD">bn-BD: Bangla (Bangladesh)</option>             <option value="bn-IN">bn-IN: Bangla (India)</option>             <option value="cs-CZ">cs-CZ: Czech (Czech Republic)</option>             <option value="da-DK">da-DK: Danish (Denmark)</option>             <option value="de-AT">de-AT: German (Austria)</option>             <option value="de-CH">de-CH: German (Switzerland)</option>             <option value="de-DE">de-DE: German (Germany)</option>             <option value="el-GR">el-GR: Greek (Greece)</option>             <option value="en-AU">en-AU: English (Australia)</option>             <option value="en-CA">en-CA: English (Canada)</option>             <option value="en-GB">en-GB: English (United Kingdom)</option>             <option value="en-IE">en-IE: English (Ireland)</option>             <option value="en-IN">en-IN: English (India)</option>             <option value="en-NZ">en-NZ: English (New Zealand)</option>             <option value="en-US">en-US: English (United States)</option>             <option value="en-ZA">en-ZA: English (South Africa)</option>             <option value="es-AR">es-AR: Spanish (Argentina)</option>             <option value="es-CL">es-CL: Spanish (Chile)</option>             <option value="es-CO">es-CO: Spanish (Columbia)</option>             <option value="es-ES">es-ES: Spanish (Spain)</option>             <option value="es-MX">es-MX: Spanish (Mexico)</option>             <option value="es-US">es-US: Spanish (United States)</option>             <option value="fi-FI">fi-FI: Finnish (Finland)</option>             <option value="fr-BE">fr-BE: French (Belgium)</option>             <option value="fr-CA">fr-CA: French (Canada)</option>             <option value="fr-CH">fr-CH: French (Switzerland)</option>             <option value="fr-FR">fr-FR: French (France)</option>             <option value="he-IL">he-IL: Hebrew (Israel)</option>             <option value="hi-IN">hi-IN: Hindi (India)</option>             <option value="hu-HU">hu-HU: Hungarian (Hungary)</option>             <option value="id-ID">id-ID: Indonesian (Indonesia)</option>             <option value="it-CH">it-CH: Italian (Switzerland)</option>             <option value="it-IT">it-IT: Italian (Italy)</option>             <option value="ja-JP">ja-JP: Japanese (Japan)</option>             <option value="ko-KR">ko-KR: Korean (Republic of Korea)</option>             <option value="nl-BE">nl-BE: Dutch (Belgium)</option>             <option value="nl-NL">nl-NL: Dutch (The Netherlands)</option>             <option value="no-NO">no-NO: Norwegian (Norway)</option>             <option value="pl-PL">pl-PL: Polish (Poland)</option>             <option value="pt-BR">pt-BR: Portugese (Brazil)</option>             <option value="pt-PT">pt-PT: Portugese (Portugal)</option>             <option value="ro-RO">ro-RO: Romanian (Romania)</option>             <option value="ru-RU">ru-RU: Russian (Russian Federation)</option>             <option value="sk-SK">sk-SK: Slovak (Slovakia)</option>             <option value="sv-SE">sv-SE: Swedish (Sweden)</option>             <option value="ta-IN">ta-IN: Tamil (India)</option>             <option value="ta-LK">ta-LK: Tamil (Sri Lanka)</option>             <option value="th-TH">th-TH: Thai (Thailand)</option>             <option value="tr-TR">tr-TR: Turkish (Turkey)</option>             <option value="zh-CN">zh-CN: Chinese (China)</option>             <option value="zh-HK">zh-HK: Chinese (Hond Kong)</option>             <option value="zh-TW">zh-TW: Chinese (Taiwan)</option>         </select>         ';
    return html;
  }
  onSettingsChange() {
    this.settings.language = $("#speech_recognition_browser_provider_language").val();
    console.debug(DEBUG_PREFIX$3 + "Change language to", this.settings.language);
    this.loadSettings(this.settings);
  }
  ...
  loadSettings(settings) {
    const processTranscript2 = this.processTranscriptFunction;
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$3 + "Using default browser STT settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    if (!speechRecognition) {
      console.warn(DEBUG_PREFIX$3 + "Speech recognition is not supported in this browser.");
      $("#microphone_button").hide();
      window.toastr.error("Speech recognition is not supported in this browser, use another browser or another provider of SillyTavern-extras Speech recognition extension.", "Speech recognition activation Failed (Browser)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      return;
    }
    ...
    recognition.onend = function() {
      listening = false;
      console.debug(DEBUG_PREFIX$3 + "recorder stopped");
      ...
      processTranscript2(newText);
    };
    recognition.onstart = function() {
      initialText = textarea.val();
      console.debug(DEBUG_PREFIX$3 + "recorder started");
    ...
    console.debug(DEBUG_PREFIX$3 + "Browser STT settings loaded");
  }
}
const DEBUG_PREFIX$2 = "<Speech Recognition module (streaming)> ";
class StreamingSttProvider {
  ...
  get settingsHtml() {
    let html = '        <div id="speech_recognition_streaming_trigger_words_div">        <span>Minimum spoken characters to trigger</span><br>        <input max="99" min="0" class="text_pole" id="speech_recognition_streaming_trigger_min_chars" type="number"><br>        <span>Trigger words</span>        <textarea id="speech_recognition_streaming_trigger_words" class="text_pole textarea_compact" type="text" rows="4" placeholder="Enter comma separated words that triggers new message, example:\nhey, hey aqua, record, listen"></textarea>        <label class="checkbox_label" for="speech_recognition_streaming_trigger_words_enabled">            <input type="checkbox" id="speech_recognition_streaming_trigger_words_enabled" name="speech_recognition_trigger_words_enabled">            <small>Enable trigger words</small>        </label>        <label class="checkbox_label" for="speech_recognition_trigger_words_included">            <input type="checkbox" id="speech_recognition_trigger_words_included" name="speech_recognition_trigger_words_included">            <small>Include trigger words in message</small>        </label>        <label class="checkbox_label" for="speech_recognition_streaming_debug">            <input type="checkbox" id="speech_recognition_streaming_debug" name="speech_recognition_streaming_debug">            <small>Enable debug pop ups</small>        </label>        </div>        ';
    return html;
  }
  onSettingsChange() {
    ...
    console.debug(DEBUG_PREFIX$2 + " Updated settings: ", this.settings);
    this.loadSettings(this.settings);
  }
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$2 + "Using default Whisper STT extension settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    $("#speech_recognition_language").val(this.settings.language);
    console.debug(DEBUG_PREFIX$2 + "streaming STT settings loaded");
  }
  async getUserMessage() {
    if (!modules.includes("streaming-stt")) {
      console.debug(DEBUG_PREFIX$2 + "Module streaming-stt must be activated in Sillytavern Extras for streaming user voice.");
      return "";
    }
    const url = new URL(getApiUrl());
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, DEBUG_PREFIX$2 + "STT Generation Failed  (streaming)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      throw new Error(`HTTP ${apiResult.status}: ${await apiResult.text()}`);
    }
...
const DEBUG_PREFIX$1 = "<Speech Recognition module (KoboldCpp)> ";
class KoboldCppSttProvider {
  ...
  loadSettings(settings) {
    if (Object.keys(settings).length == 0) {
      console.debug(DEBUG_PREFIX$1 + "Using default KoboldCpp STT extension settings");
    }
    this.settings = this.defaultSettings;
    for (const key in settings) {
      if (key in this.settings) {
    ...
    $("#speech_recognition_language").val(this.settings.language);
    console.debug(DEBUG_PREFIX$1 + "KoboldCpp STT settings loaded");
  }
  async processAudio(audioBlob) {
    const server = textgenerationwebui_settings.server_urls[textgen_types.KOBOLDCPP];
    if (!server) {
      window.toastr.error("KoboldCpp server URL is not set.");
    ...
    if (!apiResult.ok) {
      window.toastr.error(apiResult.statusText, "STT Generation Failed  (KoboldCpp)", { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true });
      throw new Error(`HTTP ${apiResult.status}: ${await apiResult.text()}`);
    }
    const result = await apiResult.json();
    return result.text;
...
const constraints = { audio: { sampleSize: 16, channelCount: 1, sampleRate: 16e3 } };
let audioChunks = [];
      ...
      if (messageStart == -1) {
        ...
        if (extension_settings.speech_recognition.Streaming.debug) {
          window.toastr.info(
            ...
            { timeOut: 1e4, extendedTimeOut: 2e4, preventDuplicates: true }
          );
        }
      } else {
      ...
      const myVAD = await window.vad.MicVAD.new({
        ...
        onSpeechEnd: async (audio) => {
          if (audioRecording && extension_settings.speech_recognition.voiceActivationEnabled) {
            ...
            if (micButton.is(":visible")) {
              micButton.trigger("click");
              await processPcmArrays(16e3, [audio]);
            }
          }
        }
      });
      myVAD.start();
      let mediaRecorder2 = new MediaRecorder(stream);
      micButton.off("click").on("click", function() {
        if (!audioRecording) {
          if (!extension_settings.speech_recognition.voiceActivationEnabled) {
            mediaRecorder2.start();
          }
          console.debug(DEBUG_PREFIX + mediaRecorder2.state);
...
function loadSettings() {
  ...
  for (const key in defaultSettings) {
    if (extension_settings.speech_recognition[key] === void 0) {
...
function isKeyComboMatch(keyCombo, event) {
  return keyCombo.code === event.code && keyCombo.ctrl === event.ctrlKey && keyCombo.alt === event.altKey && keyCombo.shift === event.shiftKey && keyCombo.meta === event.metaKey;
}
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render]]);
