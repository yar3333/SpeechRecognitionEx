...
export class BrowserSttProvider implements ISttProvider {
    ...
    onSettingsChange() {
        ...
        this.settings.language = <string>$('#speech_recognition_browser_provider_language').val();
    ...
    loadSettings(settings) {
        ...
        if (!speechRecognition) {
            ...
            window.toastr.error('Speech recognition is not supported in this browser, use another browser or another provider of SillyTavern-extras Speech recognition extension.', 'Speech recognition activation Failed (Browser)', { timeOut: 10000, extendedTimeOut: 20000, preventDuplicates: true });
            return;
        }
